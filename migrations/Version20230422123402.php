 ...
 */
final class Version20230422123402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE marque_operation (marque_id INT NOT NULL, operation_id INT NOT NULL, INDEX IDX_61EB6BF14827B9B2 (marque_id), INDEX IDX_61EB6BF144AC3583 (operation_id), PRIMARY KEY(marque_id, operation_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
